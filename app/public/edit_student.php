...
<body>
    <div class="app-container">
        <aside class="sidebar">
            <div class="sidebar-header">
                <img src="../assets/images/atc_logo.png" alt="College Logo" class="logo"> <h3>ATC Exam System</h3>
            </div>
            ...
            <header class="content-header">
                <h1 class="page-title"><i class="fas fa-user-edit"></i> Edit Student Details</h1>
                 <div class="header-actions">
                     <a href="view_students.php"><span class="nav-icon"><i class="fas fa-arrow-left"></i></span> Back to Student List</a>
                </div>
            </header>
    ...
    <script>
        ...
        // No file-specific JavaScript needed for edit_student.php
        // -------------------------------------------------------------------------------
